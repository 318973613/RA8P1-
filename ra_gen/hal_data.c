...
dmac_instance_ctrl_t g_sdmmc1_transfer_ctrl;
transfer_info_t g_sdmmc1_transfer_info =
{
    .transfer_settings_word_b.dest_addr_mode = TRANSFER_ADDR_MODE_FIXED,
    .transfer_settings_word_b.repeat_area    = TRANSFER_REPEAT_AREA_SOURCE,
    .transfer_settings_word_b.irq            = TRANSFER_IRQ_END,
...
const dmac_extended_cfg_t g_sdmmc1_transfer_extend =
{
    .offset              = 1,
    .src_buffer_size     = 1,
...
const transfer_cfg_t g_sdmmc1_transfer_cfg =
{
    .p_info              = &g_sdmmc1_transfer_info,
    .p_extend            = &g_sdmmc1_transfer_extend,
};
/* Instance structure to use this module. */
const transfer_instance_t g_sdmmc1_transfer =
{
    .p_ctrl        = &g_sdmmc1_transfer_ctrl,
    .p_cfg         = &g_sdmmc1_transfer_cfg,
    .p_api         = &g_transfer_on_dmac
};
...
sdmmc_cfg_t g_sdmmc1_cfg =
{
    ...
    .p_extend            = NULL,
    .p_lower_lvl_transfer = &g_sdmmc1_transfer,
...
{
    .mode = TIMER_MODE_PWM,
    /* Actual period: 21.47483648 seconds. Actual duty: 50%. */
    .period_counts = (uint32_t) 0x100000000,
