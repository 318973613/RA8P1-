...
// Place arena in external OSPI RAM to reduce SRAM pressure (matches face demo project pattern).
__attribute__((aligned(16), section(".ospi1_cs0_noinit"))) uint8_t sub_0001_arena[442368];
...
int sub_0001_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0001_model with size 436688 and address: 4294967295
  ...
  // Buffer output_tensor_0 with size 3024 and address: 6480
  if (clean_outputs) {
    memset(sub_0001_arena + 6480, 0, 3024);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0001_arena+6480);
  base_addrs_size[4] = 3024;

  // Buffer output_tensor_1 with size 756 and address: 0
  if (clean_outputs) {
    memset(sub_0001_arena + 0, 0, 756);
  }
