...
void gesture_compute_sub_0000(
  ...
  int8_t images_70602_11152_70256[110592]  // 3,36864
  
) {
  // Buffers allocated on the main storage (note: depends on the execution order)
    
  
  int8_t* images_11150 = (int8_t *) &main_storage[0]; // 1,3,192,192 == 110592
...
AffineQuantizeFloatToInt8(
  images,   // input data
  images_11150,   // output data
  110592,   // size
  -1,   // output zeropoint
  0.007843137718737125);   // output scale

//
// Identity - bypassing images_70602_11152_70256 operation
//
// Input images_11150: int8_t - 1,3,192,192
// Output images_70602_11152_70256: int8_t - 3,36864


memcpy(images_70602_11152_70256, images_11150, 110592 * sizeof(int8_t));
