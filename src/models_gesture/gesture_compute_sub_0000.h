...
/*
 kBufferSize_gesture_sub_0000 is a compile-time constant to be used by the user of gesture_compute_sub_0000 function
 ...
 Example of how to call the compute function:
   ...
   uint8_t my_buffer[kBufferSize_gesture_sub_0000];

   int main() {
     ...
     gesture_compute_sub_0000(my_buffer, input, output);
   }
*/
enum BufferSize_sub_0000 {

#if defined(ARM_MATH_MVEI)
  kBufferSize_gesture_sub_0000 = 110597
